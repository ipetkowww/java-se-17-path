...
public class Program {
    public static void main(String[] args) {
        ...
        // lat first
        System.out.println(radar.getAircraftInRange(6, aircraft, new CoordinateOutputFormatter(true)));

        // lon first
        System.out.println(radar.getAircraftInRange(6, aircraft, new CoordinateOutputFormatter(false)));
    }
}
